...
function drawRadarChart(divId, w, h, json) {
  ...
  var RadarChart = {
    draw: function (id, data, options) {
      ...
      cfg.maxValue = max(cfg.maxValue, maxValue);

      var allAxis = data[0].axes.map((i, j) => i.axis),	//Names of each axis
  ...
  legend.selectAll('rect')
    ...
    .style("fill", function (d, i) {
      return d3.scaleOrdinal().range(["#d6952d"]);
    });
...
function update() {
  ...
  drawRadarChart(divId, wMaior, wMaior);
};
